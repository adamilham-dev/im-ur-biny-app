    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
                ...
                child: ConstrainedBox(
                  ...
                  child: Column(
                    children: [
                      ...
                      // Subtitle — 18px Plus Jakarta Sans Medium #5c5980 leading 1.5
                      Padding(
                        padding: EdgeInsets.symmetric(
          ...
          // Biny mascot bottom-left ((48,657) → 140×147)
          Positioned(
            bottom: isPhone ? 4 : 12,
            left: isPhone ? 8 : 28,
            child: IgnorePointer(
...
class _ModeCard extends StatelessWidget {
    ...
    final cardContent = Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Title — 28px Baloo 2 Bold #2b2a45 leading 1.15
          Text(
            title,
            style: GoogleFonts.baloo2(
          ...
          // Description — 16px Plus Jakarta Sans Medium #5c5980 leading 1.5
          ConstrainedBox(
            constraints: BoxConstraints(
  ...
  // bg #7c5cfc, px=16 py=7, rounded-999

...
class _CountdownScreenState extends ConsumerState<CountdownScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        fit: StackFit.expand,
        children: [
          // ── Background — GRADIENT_LINEAR #211E36 → #13111F ──
          ...
          // ── Biny mascot — (982,640) 152×160 in 1194×834 ──
  ...
  /// "Bersiap memindai…" — 30px Baloo 2 SemiBold white
  ...
  Widget _buildCountdownCircle(double ringDiameter) {
    // 170px in Ø332 ring → ratio 0.512
  ...
  /// Hint pill — bg #0E0B1A @ 0.66, border white @ 0.08 1px
  ...
  Widget _buildHintPill(Size size) {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          // ic-hand — orange hand icon (vector stroke #FFB02E)
          Image.asset(
...
/// with a glow effect.
///
/// (track): white @ 0.08 opacity.
/// (progress): #3AD6A0 arc, innerRadius 0.916

...
/// 12 · Thank You — pixel-perfect match to .
///
/// Design target: 1194×834 (iPad landscape).
/// Layout: Frame (540 wide, 16px gap) centered vertically.
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          // ── Decorative blobs ──
          // 460×460 at (380, -160) — top right area
          // 420×420 at (660, 540) — bottom right
          if (!isPortrait) ...[
            Positioned(
              left: 380 * scale,
              top: -160 * scale,
      ...
      children: [
        ...
        Expanded(
          child: _SoftButton(
            ...
            scale: scale,
            onPressed: () {
              // Clear the previous scan so the user starts fresh, but keep

...
class TooLargeScreen extends StatelessWidget {
  const TooLargeScreen({super.key});
            ...
            child: Container(
              ...
              child: Stack(
                children: [
                  ...
                  // Red oversized detection box
                  Center(
                    child: Container(
                      width: AppResponsive.rs(size, 240),
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    'Sampah tidak muat di frame. Coba pindah ke sudut yang lebih dekat atau gunakan bagian kecil saja.',
                    style: GoogleFonts.plusJakartaSans(
  ...
  Widget _buildLandscape(BuildContext context, Size size) {
    return Scaffold(
      ...
      body: Row(
        children: [
          // Left: Camera preview with oversized detection box
          Expanded(
            flex: 5,
            child: Container(
              color: AppColors.cameraBg,
              child: Stack(
                children: [
                  ...
                  Center(
                    child: Container(
                      width: AppResponsive.rs(size, 380),
                      height: AppResponsive.rs(size, 440),
                      decoration: BoxDecoration(
                        border: Border.all(
                          color: AppColors.red,
                          width: 3,

...
class _FeedbackScreenState extends State<FeedbackScreen>
  ...
  // Using custom SVGs from assets. Color flips to primary when selected.
  static const _feedbackOptions = [
    ('Akurat', 'assets/images/feedback/Akurat.svg'),
    ('Puas', 'assets/images/feedback/Puas.svg'),
    ('Cepat', 'assets/images/feedback/Cepat.svg'),
    ('Mudah', 'assets/images/feedback/Mudah.svg'),
  ];
  ...
  Widget build(BuildContext context) {
    ...
    final scale = isPortrait
        ? (size.width / 430.0).clamp(0.4, 1.0)
  ...
  Widget _buildStar(int starIndex, double size) {
    ...
    const starSvgBase = '''<svg width="50" height="48" viewBox="0 0 50 48" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M29.6592 17.9971L29.9443 18.8184L30.8145 18.8359L45.834 19.1416L33.8623 28.2178L33.1689 28.7432L33.4209 29.5762L37.7705 43.9541L25.4404 35.374L24.7266 34.877L24.0127 35.374L11.6816 43.9541L16.0322 29.5762L16.2842 28.7432L15.5908 28.2178L3.61816 19.1416L18.6387 18.8359L19.5088 18.8184L19.7939 17.9971L24.7266 3.80664L29.6592 17.9971Z" stroke="#FFB02E" stroke-width="2.5" fill="{FILL_COLOR}"/>
</svg>''';

    final svgString = starSvgBase.replaceFirst('{FILL_COLOR}', isActive ? '#FFB02E' : 'none');
  ...
  Widget _buildChip({
    ...
    final textFg = isSelected ? AppColors.primary : AppColors.textPrimary;
    final iconFg = isSelected ? AppColors.primary : const Color(0xFF908DAC);
    return GestureDetector(
      onTap: onTap,
      behavior: HitTestBehavior.opaque,
    ...
    return Container(
      ...
      child: ElevatedButton(
        ...
        child: Row(
          ...
          children: [
            SvgPicture.asset(
              'assets/images/feedback/Send.svg',
              width: 24 * scale,
              height: 24 * scale,
              colorFilter: ColorFilter.mode(AppColors.textOnPrimary, BlendMode.srcIn),
            ),

...
class MixedPartialScreen extends StatelessWidget {
  const MixedPartialScreen({super.key});
            ...
            child: Container(
              ...
              child: Stack(
                children: [
                  ...
                  // Partial detection box (cut off on the right side)
                  Positioned(
                    left: 30,
                    top: 30,
                    child: ClipRect(
                      child: Container(
                        width: AppResponsive.rs(size, 180),
                        height: AppResponsive.rs(size, 120),
                  ...
                  // Clip indicator on the right edge
                  Positioned(
                    right: 12,
                    top: 60,
                    bottom: 60,
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: AppResponsive.rs(size, 4)),
                        Text(
                          'terpotong',
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    'Ada sampah yang tidak tertangkap kamera sepenuhnya. Geser ke tengah papan.',
                    style: GoogleFonts.plusJakartaSans(
  ...
  Widget _buildLandscape(BuildContext context, Size size) {
    return Scaffold(
      ...
      body: Row(
        children: [
          // Left: Camera preview with partial detection box
          Expanded(
            flex: 5,
            child: Container(
              color: AppColors.cameraBg,
              child: Stack(
                children: [
                  ...
                  Positioned(
                    ...
                    child: ClipRect(
                      child: Container(
                        width: AppResponsive.rs(size, 260),
                        height: AppResponsive.rs(size, 280),
                        decoration: BoxDecoration(
                          border: Border.all(
                            color: AppColors.warning,
                            width: 3,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: GoogleFonts.plusJakartaSans(
                            color: AppColors.warning.withValues(alpha: 0.7),
                            fontSize: AppResponsive.sp(size, 10),
                            fontWeight: FontWeight.w600,
                          ),
                        ),
                      ],
